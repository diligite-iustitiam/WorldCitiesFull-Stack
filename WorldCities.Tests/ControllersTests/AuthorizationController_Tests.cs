...
{
    public class AuthorizationController_Tests
    {
        [Fact]
        public async Task CreateDefaultUsers()
        {
            ...
            var options = new
             DbContextOptionsBuilder<APIAuthorizationDbContext>()
                .UseInMemoryDatabase(databaseName: "APIAuthorization")
                .Options;
            ...
            // in-memory DB
            using var context = new APIAuthorizationDbContext(options);
